...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["show_status_display"], show_status_display)
	...
	READ_FILE(S["lcl_abno_pref"], lcl_abno_pref)
	READ_FILE(S["backpack_visibility"], backpack_visibility)
	...
	show_status_display = sanitize_integer(show_status_display, 0, 2, initial(show_status_display))
	...
	lcl_abno_pref	= SANITIZE_LIST(lcl_abno_pref)
	backpack_visibility = sanitize_integer(backpack_visibility, FALSE, TRUE, initial(backpack_visibility))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["show_status_display"], show_status_display)
	...
	WRITE_FILE(S["lcl_abno_pref"], lcl_abno_pref)
	WRITE_FILE(S["backpack_visibility"], backpack_visibility)
